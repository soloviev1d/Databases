...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getUserInfo`(IN param1 VARCHAR(45) COLLATE utf8mb4_general_ci, OUT param2 INT)
BEGIN
    DECLARE UserName VARCHAR(45) COLLATE utf8mb4_general_ci; 
    SET UserName = 'Ivan'; 
...
-- Dump completed on 2023-10-05 20:07:08
